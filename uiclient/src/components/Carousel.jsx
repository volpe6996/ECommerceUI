...
const slides = [
  { src: img1, title: "Now you don’t have to choose between privacy and progress", description: "Google Cloud Confidential Computing, where privacy meets perfomance powered by AMD EPYC™ processors.", button: "Learn More" },
...
const Carousel = () => {
    ...
    useEffect(() => {
      ...
      timeoutRef.current = setTimeout(
        () =>
          setCurrentIndex(
            (prevIndex) => prevIndex === slides.length - 1 ? 0 : prevIndex + 1), delay);
    ...
    return (
        <div className="col-12 row slider p-0 m-0">
            <div className="sliderContainer d-flex flex-lg-row flex-column">

              {/* image */}
                <div className="col-lg-6 col-12 p-0 m-0">
                    <img className="slideImage" src={slides[currentIndex].src}  height="300" />
                </div>

              {/* info */}
                <div className="slideInfo d-flex flex-column col-lg-6 col-12 m-0">
                    ...
                    <div className="">
                        <button className="row col-xl-4 col-lg-6 col-md-8 col-12 align-self-end flex-column justify-content-center p-2 m-0 mt-4">
